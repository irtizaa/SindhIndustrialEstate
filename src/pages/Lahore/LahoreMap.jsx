...
const parseFdt = (f) => {
  ...
  return {
    ...
    fetchData("http://103.31.83.47:5000/api/l_handhole", setHandholes, parseCoordinates);
    fetchData("http://103.31.83.47:5000/api/l_joints", setJoints, parseCoordinates);
    fetchData("http://103.31.83.47:5000/api/l_customers", setCustomers, parseCoordinates);

    fetchData("http://103.31.83.47:5000/api/l_fat", setFat, parseFat);
    fetchData("http://103.31.83.47:5000/api/l_fdt", setFdt, parseFdt);

    fetchData("http://103.31.83.47:5000/api/l_nodes", setNodes, parseCoordinates);
    fetchData("http://103.31.83.47:5000/api/l_metroFiber", setFibers, parseFiber);
    fetchData("http://103.31.83.47:5000/api/l_fa", setFiberAttachments, parseFiberAttachment);
  }, []);

  // Map Initialization
  useEffect(() => {
    loadGoogleMapsScript(() => {
      const Rawalpindi = { lat: 31.5204, lng: 74.3587 };  
