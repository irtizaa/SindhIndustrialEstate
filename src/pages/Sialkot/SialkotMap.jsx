...
import SialkotMapWidgets from "./SialkotMapWidgets";
...
const parsePoles = (p) => {
  ...
  return {
    ...
    fetchData("http://localhost:5000/api/s_handhole", setHandholes, parseCoordinates);
    fetchData("http://localhost:5000/api/s_joints", setJoints, parseCoordinates);
    fetchData("http://localhost:5000/api/s_customers", setCustomers, parseCoordinates);
    fetchData("http://localhost:5000/api/s_poles", setPoles, parsePoles);

    fetchData("http://localhost:5000/api/s_fat_splitter", setFat, parseFat);
    fetchData("http://localhost:5000/api/s_fdtPon", setFdt, parseFdt);

    fetchData("http://localhost:5000/api/s_nodes", setNodes, parseCoordinates);
    fetchData("http://localhost:5000/api/s_metroFiber", setFibers, parseFiber);
    fetchData("http://localhost:5000/api/s_fiberattachment", setFiberAttachments, parseFiberAttachment);
  }, []);

  // Map Initialization
  useEffect(() => {
    loadGoogleMapsScript(() => {
      const Sialkot = { lat: 32.4925, lng: 74.5312 };                                                         
