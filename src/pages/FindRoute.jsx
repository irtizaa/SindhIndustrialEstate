...
export default function FindRoute({ map }) {
  ...
  useEffect(() => {
    ...
    map.controls[window.google.maps.ControlPosition.RIGHT_TOP].push(controlWrapperRef.current);
  ...
  return (
    ...
    <div ref={controlWrapperRef} className="mr-[10px] mt-[10px]">
      {!isOpen ? (
        <button 
        ...
        >
          <Navigation size={22} className="text-[#666666]" />
        </button>
      ) : (
